	...
	<table>
		<tbody>
			...
			<tr>
				...
				<td>
					<div class="form-control-box">
						<input type="file" accept="video/*" name="file__article__${article.id}__common__attachment__2" />
					</div> 
			...
			<tr>
				...
				<td>
					<div class="form-control-box">
						<input type="file" accept="image/*" name="file__article__${article.id}__common__attachment__3" />
					</div>
					<c:if test="${article.extra.file__common__attachment['3'] != null}">
						<div class="video-box">
							<div class="img-box" style="max-width:500px;">
								<img src="/usr/file/showImg?id=${article.extra.file__common__attachment['3'].id}" alt="" />
							</div>
						</div>
					</c:if>
				</td>
